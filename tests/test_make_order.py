...
class TestMakeOrder:
    ...
    def test_make_order_with_ingredient_authorized_user_return_200_ok(self, create_user_valid_data):
    ...
    def test_make_order_without_ingredients_authorized_user_return_400_bad_request(self, create_user_valid_data):
        token = create_user_valid_data.json()["accessToken"]
    ...
    def test_make_order_with_ingredient_non_authorized_user_return_200_ok(self):
        make_order_response = ApiMethods.make_order('', random_make_order_body())
    ...
    def test_make_order_without_ingredients_non_authorized_user_return_400_bad_request(self):
        make_order_response = ApiMethods.make_order('', {})
    ...
    @allure.description(
        'Запрос POST на /api/orders с передачей невалидного id ингредиента вернет 500 Internal Server Error')
    def test_make_order_with_invalid_ingredient_id_return_500_internal_server_error(self):
        make_order_body = {'ingredients': ['invalid']}
        make_order_response = ApiMethods.make_order('', make_order_body)
